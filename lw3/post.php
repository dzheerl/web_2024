...
<body class="page">
  <header class="header-menu menu">
    <a href="#">
      <img class="logo" src="./static/img/header_logo_post.png" alt="Escape.">
    </a>
  ...
  <section class="page-about">
    <h1 class="page-about__title horizontal-center" > The Road Ahead </h1>
    <p class="page-about__description horizontal-center"> The road ahead might be paved - it might not be. </p>
  </section>
  <img class="page-img" src="./static/img/the_road_a_head.png" alt="The Road Ahead"/>
  <div class="page-content horizontal-center">
     <p >
       ...
       white covering of frost,
       and they seemed to lean towards each other, black and ominous, in the fading light. A vast silence reigned over the
       land.
       ...
       as the smile of the sphinx, a laughter cold as
       the frost and partaking of the grimness of infallibility. It was the masterful and incommunicable wisdom of eternity
     ...
     <p>
       ...
       surged like a wave before it.
       On the sled, securely lashed, was a long and narrow oblong box. There were other things on the sled—blankets, an
       axe, and a coffee-pot and frying-pan;
    ...
    <p>
      ...
      until he would never move nor struggle again.
      It is not the way of the Wild to like movement. Life is an offence to it, for life is movement; and the Wild aims
      always to destroy movement.
      It freezes the water to prevent it running to the sea; it drives the sap out of the trees till they are frozen to
      their mighty hearts;
      and most ferociously and terribly of all does the Wild harry and crush into submission man—man who is the most
      restless of life,
    ...
    <p>
      ...
      Their bodies were covered with fur and soft-tanned leather. Eyelashes and cheeks and lips were so coated with the
      crystals
      from their frozen breath that their faces were not discernible. This gave them the seeming of ghostly masques,
      undertakers
      in a spectral world at the funeral of some ghost. But under it all they were men, penetrating the land of desolation
      and
      mockery and silence, puny adventurers bent on colossal adventure, pitting themselves against the might of a world as
      remote
